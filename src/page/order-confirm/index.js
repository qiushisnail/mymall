...
import renderAddress from './address-list.art';
import renderProduct from './product-list.art';
...
var page = {
    ...
    loadAddressList: function () {
        ...
        _address.getAddressList(function (res) {
            ...
            var addressListHtml = renderAddress(res);
    ...
    loadProductList: function () {
        ...
        _order.getProductList(function (res) {
            var productListHtml = renderProduct(res);
